...
export class ErrorContextBuilder {
  ...
  addActionContext(actionType: string, payload: unknown): this {
    this.context.actionType = actionType
    this.context.payload = payload
    return this
  }
  
  addStateContext(stateName: string, stateData: unknown): this {
    this.context.stateName = stateName
    this.context.stateData = stateData
    return this
  }
  
  addValidationContext(validator: string, input: unknown): this {
  ...
  addQueryContext(queryName: string, parameters: unknown): this {
  ...
  static forCommand(commandName: string, payload: unknown): Record<string, unknown> {
